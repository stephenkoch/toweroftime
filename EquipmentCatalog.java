public class EquipmentCatalog 
{
	...
	public static Weapon Quarterstaff            = new Weapon("Axe","When your quartered.","Weapon",3,5);
	public static Weapon LongSword               = new Weapon("Long Sword","Noun.- A sword that is long.","Weapon",2,8);
	
	public static Weapon ShortBow                = new Weapon("Short Bow","Look at the size of that thing.","Weapon",2,6);
	public static Weapon CompositeShortBow       = new Weapon("Composite Short Bow","Real creative with the names aren't yea.","Weapon",2,7);
